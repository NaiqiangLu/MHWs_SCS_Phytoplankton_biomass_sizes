...
%   and t indicates temporal dimension.  完整的sst数据源
%   
%   MHW, mclim, m90 - Outputs from function detect  海洋热浪事件，气候态均值，90%分位阈值用detect函数产生
%
%   loc - A vector containing two numeric value indicating the grid of
%   MHW/MCS in TEMP.  指示是在哪一个网格
%
%   data_start - A numeric value indicating the start year of TEMP.  sst数据源起始时间
%   
%
%   date_start - A vector indicating the starting date of graph.  画mhw时间线图的起始时间
%   
%   date_end - A vector indicating the end date of graph.     画mhw时间线图的结束时间
%    
%   'Event' - Default is 'MHW'.  默认选择热浪事件
...
%   triplet.  线的颜色
%
%   'Alpha' - Default is 0.5. The transparency of color lump.  指颜色的透明度
% 
%   'LineWidth' - Default is 2. The line width of time series.  线宽
%
%   'Fontsize' - Default is 16. The size of font in plot.   字体大小
