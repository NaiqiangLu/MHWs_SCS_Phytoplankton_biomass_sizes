...
m_contourf(Lon,Lat,MHWs_Qnet_Season{1}',80,'linestyle','none');
shading flat      % 建议用flat，方便保持色阶分明
hold on
% ===== 添加等值线（无数字）=====
contour_levels = -60:40:60;   % 等值线间隔可调整
m_contour(Lon,Lat,MHWs_Qnet_Season{1}',contour_levels,...
    'LineColor','k',...
    'LineWidth',0.8);
...
figure('Position',[200,200,900,800],'Resize','off','Color','w');
m_proj('equidistant','lon',[105 123],'lat',[0 25]);
m_contourf(Lon,Lat,MHWs_Qnet_Season{2}',80,'linestyle','none');
shading flat      % 建议用flat，方便保持色阶分明
hold on
% ===== 添加等值线（无数字）=====
contour_levels = -60:40:60;   % 等值线间隔可调整
m_contour(Lon,Lat,MHWs_Qnet_Season{2}',contour_levels,...
    'LineColor','k',...
    'LineWidth',0.8);
...
figure('Position',[200,200,900,800],'Resize','off','Color','w');
m_proj('equidistant','lon',[105 123],'lat',[0 25]);
m_contourf(Lon,Lat,MHWs_Qnet_Season{3}',80,'linestyle','none');
shading flat      % 建议用flat，方便保持色阶分明
hold on
% ===== 添加等值线（无数字）=====
contour_levels = -60:40:60;   % 等值线间隔可调整
m_contour(Lon,Lat,MHWs_Qnet_Season{3}',contour_levels,...
    'LineColor','k',...
    'LineWidth',0.8);
...
figure('Position',[200,200,900,800],'Resize','off','Color','w');
m_proj('equidistant','lon',[105 123],'lat',[0 25]);
m_contourf(Lon,Lat,MHWs_Qnet_Season{4}',80,'linestyle','none');
shading flat      % 建议用flat，方便保持色阶分明
hold on
% ===== 添加等值线（无数字）=====
contour_levels = -60:40:60;   % 等值线间隔可调整
m_contour(Lon,Lat,MHWs_Qnet_Season{4}',contour_levels,...
    'LineColor','k',...
    'LineWidth',0.8);
