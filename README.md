...
This repository contains the MATLAB codes used in the study:
...
| **SCS_Seasonal_MHWs_Chl-a_analysis** | Chlorophyll-a anomaly analyses |
| **SCS_Seasonal_MHWs_BBP_Cphyto_analysis** | Phytoplankton carbon biomass (Cphyto) analyses derived from BBP products |
| **SCS_Seasonal_MHWs_PFTs_analyse** | Phytoplankton functional type (PFT) analyses and phytoplankton size structure |

---

# Accessing the Codes

All MATLAB source codes are publicly available in their corresponding branches.

To access a specific analytical module:

1. Click the **Branch** selector at the top-left of the GitHub repository.
...
Some scripts may require the following MATLAB Toolboxes:
